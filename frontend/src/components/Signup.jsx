...
const Signup = ({ API_URL = "https://expense-tracker-backend-fema.onrender.com", onSignup }) => {
  ...
  const navigate = useNavigate();
   ...
   // to fetch profile
    ...
    // to validate that all fileds are filled by user or not
    const validateForm = () => {
    const newErrors = {};
